...
- Machines for Headless WebAuthn activities have [Linux](../../../installation.mdx#linux), [macOS](../../../installation.mdx#macos) or [Windows](../../../installation.mdx#windows-tsh-and-tctl-clients-only) `tsh` binary installed.
